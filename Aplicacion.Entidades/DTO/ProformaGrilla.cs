...
namespace Aplicacion.Entidades.DTO
{
    ...
    public class ProformaGuardarRequest {
        public ent.Proforma ProformaCabecera { get; set; }
        public IEnumerable<ent.Proformadetalle> ProformaDetalle { get; set; }
    }

    public class ProformaCerrarRequest {
